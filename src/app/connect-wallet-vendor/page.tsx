...
const ConnectWalletComponent = () => {
  ...
  useEffect(() => {
    if (isConnected && chainId) {
      ...
      const registeredUser = localStorage.getItem(`vendor_${address}`);
      if (registeredUser) {
  ...
  const handleOnboardingSubmit = (e: React.FormEvent) => {
    ...
    if (address) {
      ...
      localStorage.setItem(`vendor_${address}`, JSON.stringify(userData));
      setIsRegistered(true);
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-center">
          <div className="flex items-center justify-center space-x-3 mb-4">
            ...
            <div className="text-left">
              ...
              <p className="text-blue-100 text-sm">Vendor Portal</p>
            </div>
          </div>
          <h2 className="text-2xl font-bold text-white">Connect Your Wallet</h2>
          <p className="text-blue-100 mt-2">Join the transparent tendering platform</p>
        </div>
          ...
          {!isConnected ? (
            ...
            <>
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm">Please complete your vendor registration</p>
              </div>
              ...
              <form onSubmit={handleOnboardingSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    value={headOfBids}
                    onChange={(e) => setHeadOfBids(e.target.value)}
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <>
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 text-sm font-semibold mb-2">{organizationName}</p>
